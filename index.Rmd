...
knitr::include_graphics('img/kappa_example.png')
```
...
```{r echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics('img/precision.png')
```
...
knitr::include_graphics('img/recall.png')
```
...
```{r echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics('img/trade_off.png')
```
...
knitr::include_graphics('img/leave_one_out_CV.png')
```
